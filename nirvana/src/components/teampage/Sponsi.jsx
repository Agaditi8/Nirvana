...
import { sponsiTeam } from "@/data/team/sponsi";
    ...
    return (
      ...
      "
        ...
        ================================================== */}
            ...
            "
                    >
                        The people who build connections, create
                        partnerships and bring opportunities to
                        Nirvana beyond the studio.
                    </p>
                </motion.div>
        ...
        ================================================== */}
            ...
            "
                    >
                        {sponsiTeam.cores.map((member, index) => (
                            <MemberCard
                                key={member.name}
                                member={member}
                                index={index + 1}
        ...
        ================================================== */}
            ...
            "
                    >
                        {sponsiTeam.coordinators.map((member, index) => (
                            <MemberCard
                                key={member.name}
                                member={member}
                                index={index + 5}
