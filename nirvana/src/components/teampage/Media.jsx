...
import { mediaTeam } from "@/data/team/media";
    ...
    return (
      ...
      "
        ...
        ================================================== */}
            ...
            "
                    >
                        The photographers, videographers and visual
                        storytellers capturing the moments that define
                        Nirvana.
                    </p>
                </motion.div>
        ...
        ================================================== */}
            ...
            "
                    >
                        {mediaTeam.cores.map((member, index) => (
                            <MemberCard
                                key={member.name}
                                member={member}
                                index={index + 1}
        ...
        ================================================== */}
            ...
            "
                    >
                        {mediaTeam.coordinators.map((member, index) => (
                            <MemberCard
                                key={member.name}
                                member={member}
                                index={index + 5}
