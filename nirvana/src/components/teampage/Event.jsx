...
import { eventTeam } from "@/data/team/event";
    ...
    return (
      ...
      ===================================================== */}
        ...
        ================================================== */}
          ...
          "
                >
                    <p className="text-micro mb-7 text-[var(--color-violet-muted)]">
                        01 — TEAM
                    </p>
            ...
            "
                    >
                        The people behind the planning, coordination and
                        execution that bring Nirvana's ideas to life.
                    </p>
                </motion.div>
        ...
        ================================================== */}
            ...
            "
                    >
                        {eventTeam.cores.map((member, index) => (
                            <MemberCard
                                key={member.name}
                                member={member}
                                index={index + 1}
        ...
        ================================================== */}
            ...
            "
                    >
                        {eventTeam.coordinators.map((member, index) => (
                            <MemberCard
                                key={member.name}
                                member={member}
                                index={index + 5}
